...
const Home = () => {
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 bg-gray-100">
      <div className='flex flex-1 flex-col md:flex-row z-20 xl:w-full h-20 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64'>
        <div className='flex-1'>
          ...
          <h1 className='bold-52 lg:bold-68 md:bold-64'>
            Powering Your <span className='text-green-50'>Digital Success</span>
          </h1>
          <p className='regular-16 mt-6 text-gray-30 '>
            Elevate your brands online presence with our captivating websites and unforgettable branding experiences.
            We turn your visions into reality, delivering creative excellence that sets your brand apart.
