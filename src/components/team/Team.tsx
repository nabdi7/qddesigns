...
const Team = () => {
  return (
    <div className=" lg:py-10">
      <div className="max-w-7xl px-5 md:px-10 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-screen-xl  mx-auto">
          <div className="max-w-3xl mx-auto lg:text-center mb-10 lg:mb-14">
            <h2 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
              Our team
            </h2>
            <p className="mt-1 text-sm lg:text-base text-neutral-400">
              Thorough strategy—from careful research and strategic planning to
              the smooth execution of brand development and the launch of
